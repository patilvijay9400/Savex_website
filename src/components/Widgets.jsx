...
const Widgets = () => {
  return (
    <div>
      <h2 className="fw-bold px-2 px-md-5 mt-4">HOTS WIDGETS</h2>
      <div className="row text-white row-cols-1 row-cols-lg-2 g-3 px-2 px-md-5 mx-0">
        <div className="col">
          <div className="row h-100 mx-0">
            <div className="col-6 pe-2">
              <div className="p-2 h-100 p-md-4 h-100 widget-img-1 rounded-5 shadow-sm">
                <h3>VEEAM</h3>
            ...
            <div className="col-6 ps-2">
              <div className="p-2 h-100 p-md-4 h-100 widget-img-2 rounded-5 shadow-sm">
                <h3>SOLARWINDS</h3>
      ...
      <div className="row mt-4 mx-0">
        <div className="col px-0">
          <div className="p-2 p-md-5 h-100 widget-img-6 shadow-sm">
            <h2 className="text-white mt-3 mb-2">Save Upto 65% on BenQ<br/> Products</h2>
